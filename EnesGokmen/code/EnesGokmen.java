...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        double x_scale = 800.0, y_scale = 400.0; // Define the dimensions of the canvas
        StdDraw.setCanvasSize(800, 400); // Set the canvas size
        StdDraw.setXscale(0.0, x_scale); // Set the x-scale of the canvas
        StdDraw.setYscale(0.0, y_scale); // Set the y-scale of the canvas
        ...
        double[] initial_ball_pos = {400,18}; // Initial position of the ball in the format {x, y}
        ...
        int pauseDuration = 18; // Duration between frames in milliseconds
        ...
        while (!isThrown){
            ...
            StdDraw.textLeft(10,y_scale-20,"Angle:"+ throwAngle);
        ...
        while (!isItOver){
            ...
            if (frame >10) {
                ...
                if (isPaused) {
                    StdDraw.setPenColor(StdDraw.BLACK);
                    StdDraw.text(37, y_scale - 12, "PAUSED");
                    StdDraw.show();
                    StdDraw.pause(pauseDuration);
                    continue;
                }
        ...
        StdDraw.filledRectangle(x_scale-50,y_scale-20,50,20);
        ...
        if (victory){
            StdDraw.text(x_scale/2,y_scale/2,"VICTORY!");
            StdDraw.setFont(scoreFont);
            StdDraw.text(x_scale/2,y_scale/6, "Score: " + score);
        } else{
            StdDraw.text(x_scale/2,y_scale/3.5, "-GAME OVER-");
            StdDraw.setFont(scoreFont);
            StdDraw.text(x_scale/2,y_scale/6, "Score: " + score);
        }
